...
双方率比 $\hat{\rho} = 2.067$（SE = 0.024），95% Wald CI 为 [2.02, 2.11]，E-test p < 0.0001。结论：**双方损失率存在极显著的统计差异，俄方日均验证损失约为乌方的 2 倍。**
