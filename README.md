...
| 日均损失率 λ̂ | 16.19/天 | 8.00/天 | **2.02** | < 0.0001 |
| 95% Exact CI | [15.99, 16.39] | [7.86, 8.14] | — | — |
| 率比 95% Wald CI | — | — | **[1.98, 2.07]** | — |
...
1. **双方损失率存在极显著差异（p < 0.0001）**：Oryx 影像验证数据显示俄方日均损失约为乌方的 2 倍（率比 2.06:1），观测灵敏度分析表明该率比在中等非对称观测假设下具有稳健性
2. **时序逆转——从 3.7:1 到 0.65:1**：2022 年初期俄方损失远多于乌方，但 2025-2026 年乌方反超
